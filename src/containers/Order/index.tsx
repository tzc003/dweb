...
import logo1Png from '@/images/upi1.png';
import logo2Png from '@/images/upi.png';
    ...
    return (
      <div className="p-order">
        ...
        <div className="payment-info step1">
          ...
          <div className="flex">
            ...
            <div className="right">
              ...
              <input value={usePayInfo?.account} id="upi-id" readOnly style={{fontSize: 35}} />
              <div className="copy" onClick={() => copy('upi-id')}>Copy</div>
            </div>
          </div>
        </div>
        <div className="section step2">
          <div className="title">
            Step 2.Open online banking or wallet, transfer to the UPI account.
          </div>
        </div>
        ...
        <div className="bottom-btn">
          <div className="btn" onClick={this.handleOk}>Enter UPI Ref/UTR No.</div>
        </div>
      </div>
    );
  }
